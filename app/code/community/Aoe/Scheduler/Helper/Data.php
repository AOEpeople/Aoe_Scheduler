...
class Aoe_Scheduler_Helper_Data extends Mage_Core_Helper_Abstract
{
    ...
    public const XML_PATH_EMAIL_TEMPLATE      = 'system/cron/error_email_template';
    public const XML_PATH_EMAIL_IDENTITY      = 'system/cron/error_email_identity';
    public const XML_PATH_EMAIL_RECIPIENT     = 'system/cron/error_email';
    public const XML_PATH_CRON_USER           = 'system/cron/cronUser';
    public const XML_PATH_KILL_ON_WRONG_USER  = 'system/cron/killOnIncorrectUser';
    public const XML_PATH_SHOW_WRONG_USER_MSG = 'system/cron/showCronUserMessage';
    public const XML_PATH_RUN_ONLY_IF_CACHE_PREFIX_ID_MATCHES = 'system/cron/runOnlyIfCachePrefixIdMatches';

    public const VAR_LAST_RUN_USER_CODE       = 'aoescheduler_lastrunuser';
    ...
    public function getLastExecutionTime($jobCode)
    {
        ...
        $schedules->load();
        if ((is_countable($schedules) ? count($schedules) : 0) == 0) {
            return false;
        }
