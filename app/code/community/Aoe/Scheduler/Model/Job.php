 ...
 * @method Aoe_Scheduler_Model_Job setJobCodesAfter($jobCodesAfter)
 * @method string getJobCodesAfter()
 * @method Aoe_Scheduler_Model_Job setScheduleTime($scheduleTime)
